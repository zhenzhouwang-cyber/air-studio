...
- **Suggested command**: Which command to use (prefer: /extract, /normalize, /quieter, /overdrive, /distill, /adapt, /arrange, /harden, /critique, /audit, /typeset, /onboard, /delight, /polish, /bolder, /optimize, /clarify, /animate, /colorize — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /extract, /normalize, /quieter, /overdrive, /distill, /adapt, /arrange, /harden, /critique, /audit, /typeset, /onboard, /delight, /polish, /bolder, /optimize, /clarify, /animate, /colorize. You may also suggest other installed skills you're sure exist, but never invent commands.
